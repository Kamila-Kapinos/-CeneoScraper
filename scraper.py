...
url = "https://www.ceneo.pl/91714422#tab=reviews" #kod ma być pobierany od uzytkownika
all_opinions = []
...
while(url):
    ...
    for opinion in opinions:
        ...
        author = opinion.select_one(
            "span.user-post__author-name").get_text().strip()

        try:
            recommendation = opinion.select_one(
                "span.user-post__author-recomendation > em").get_text().strip()
